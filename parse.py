...
def parse_args():
    ...
    parser.add_argument('--data_name', type=str,default='Office_Products',
                        help="available datasets: [Office_Products, Tools_and_Home_Improvement, Toys_and_Games, Beauty]")
    ...
    #LTOCF
    parser.add_argument('--time_split', type=int, default=4)
    parser.add_argument('--solver', type=str, default='euler')
    #parser.add_argument('--pretrain', type=int, default=0)
    parser.add_argument('--learnable_time', type=bool, default=True)
    parser.add_argument('--dual_res', type=bool, default=False)
    ...
    #PyTorch Geometric optimization
